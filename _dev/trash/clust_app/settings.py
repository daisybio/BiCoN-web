...
ROOT_URLCONF = '_dev.trash.clust_app.urls'
...
TEMPLATE_DIRS = [os.path.join(BASE_DIR, 'clustering/../../../clustering/templates')]
...
STATIC_ROOT = os.path.join(BASE_DIR, 'clustering/../../../clustering/static')
