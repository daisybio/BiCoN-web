...
#	url(r'list.html', views.list_2),
	...
	url(r'on_one_page.html', views.clustering_6_4),
	url(r'on_two_pages.html', views.clustering_6_4_part_2),
	url(r'clustering_6_part_4.html', views.clustering_6_4),
	...
	url(r'clustering_6_part_1.html', views.clustering_6_4_part_2),
	url(r'clustering_6.html', views.clustering_6_new),
...
#	url(r'^list/$', views.list_2, name='list'),
	...
	url(r'^on_one_page/$', views.clustering_6_4, name='clustering_6_part_1_3'),
	url(r'^on_two_pages/$', views.clustering_6_4_part_2, name='clustering_6_part_1_2'),
	url(r'^clustering_6_part_4/$', views.clustering_6_4, name='clustering_6_4'),
	...
	url(r'^clustering_6_part_1/$', views.clustering_6_4_part_2, name='clustering_6_part_1'),
	url(r'^clustering_6/$', views.clustering_6_new, name='clustering_6'),
