...
from clustering.tasks import make_empty_figure,algo_output_task,empty_log_file,add_loading_image,remove_loading_image,import_ndex,read_enrichment,read_ndex_file_4,read_enrichment_2,convert_gene_list,check_input_files,script_output_task,preprocess_file,list_metadata_from_file,preprocess_clinical_file,preprocess_ppi_file,preprocess_file_2,run_enrichment
from django.core.cache import cache
import os.path
...
def clustering_no_sessions(request):
	...
	if('input_own_file' in request.POST and 'display_old_results' in request.POST and request.user.is_authenticated):
		...
		if(input_valid == "true"):
			...
			try:
				result1 = algo_output_task.delay(1,lgmin,lgmax,exprstr,ppistr,nbr_iter,nbr_ants,evap,epsilon,hi_sig,pher_sig,"none",gene_set_size,nbr_groups)
				...
				result2 = script_output_task.delay(T,row_colors,col_colors,G2,means,genes_all,adjlist,genes1,group1_ids,group2_ids,clinicalstr,jac_1,jac_2,survival_col_name,clinicaldf,"none")
			...
			return render(request, 'clustering/clustering_no_sessions.html', {'list_of_files':list_of_files,'ret_dat':ret_metadata,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'list_of_files_2':list_of_files_2,'pval':p_val})
	if('redo_analysis' in request.POST and request.user.is_authenticated):
		if(request.POST['redo_analysis']):
			...
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				if not(has_clin_data == "true"):
					...
					ret_metadata = ""
				try:				
					result1 = algo_output_task.delay(1,lgmin,lgmax,exprstr,ppistr,nbr_iter,nbr_ants,evap,epsilon,hi_sig,pher_sig,"none",gene_set_size)
					(T,row_colors,col_colors,G2,means,genes_all,adjlist,genes1,group1_ids,group2_ids,jac_1,jac_2) =result1.get()				
					result2 = script_output_task.delay(T,row_colors,col_colors,G2,means,genes_all,adjlist,genes1,group1_ids,group2_ids,clinicalstr,jac_1,jac_2,survival_col_name,clinicaldf,"none")
				...
				copyfile(("/code/clustering/static/genelist_1.txt"),("clustering/static/userfiles/genelist_1.txt"))
				copyfile(("/code/clustering/static/genelist_2.txt"),("clustering/static/userfiles/genelist_2.txt"))
				return render(request, 'clustering/clustering_no_sessions.html', {'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'ret_dat':ret_metadata})
		...
		try:
			if(enr_type == "kegg_enrichment"):
				result1 = run_enrichment.delay("genelist.txt",pval_enr,"/code/clustering/data/test/enrichr_kegg",['KEGG_2016','KEGG_2013'])
				result2 = run_enrichment.delay("genelist_1.txt",pval_enr,"/code/clustering/data/test2/enrichr_kegg",['KEGG_2016','KEGG_2013'])
				result3 = run_enrichment.delay("genelist_2.txt",pval_enr,"/code/clustering/data/test3/enrichr_kegg",['KEGG_2016','KEGG_2013'])
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				result4 = read_enrichment.delay("/code/clustering/data/test/enrichr_kegg/KEGG_2013.test_name.enrichr.reports.txt",pval_enr)
				result5 = read_enrichment.delay("/code/clustering/data/test2/enrichr_kegg/KEGG_2013.test_name.enrichr.reports.txt",pval_enr)
				result6 = read_enrichment.delay("/code/clustering/data/test3/enrichr_kegg/KEGG_2013.test_name.enrichr.reports.txt",pval_enr)
				result7 = read_enrichment_2.delay("/code/clustering/data/test2/enrichr_kegg/KEGG_2013.test_name.enrichr.reports.txt","/code/clustering/data/test3/enrichr_kegg/KEGG_2013.test_name.enrichr.reports.txt",pval_enr)
				...
				result1 = run_enrichment.delay("genelist.txt",pval_enr,"/code/clustering/data/test/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result2 = run_enrichment.delay("genelist_1.txt",pval_enr,"/code/clustering/data/test2/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result3 = run_enrichment.delay("genelist_2.txt",pval_enr,"/code/clustering/data/test3/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				#result1 = run_go_enrichment.delay("genelist.txt",pval_enr)
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				result4 = read_enrichment.delay("/code/clustering/data/test/enrichr_go/GO_Biological_Process_2018.test_name.enrichr.reports.txt",pval_enr)
				result5 = read_enrichment.delay("/code/clustering/data/test2/enrichr_go/GO_Biological_Process_2018.test_name.enrichr.reports.txt",pval_enr)
				result6 = read_enrichment.delay("/code/clustering/data/test3/enrichr_go/GO_Biological_Process_2018.test_name.enrichr.reports.txt",pval_enr)
				result7 = read_enrichment_2.delay("/code/clustering/data/test2/enrichr_go/GO_Biological_Process_2018.test_name.enrichr.reports.txt","/code/clustering/data/test3/enrichr_go/GO_Biological_Process_2018.test_name.enrichr.reports.txt",pval_enr)
				enrichment_dict = result4.get()
				enrichment_dict_2 = result5.get()
				enrichment_dict_3 = result6.get()	
				(enrichment_dict_4,enrichment_dict_5) = result7.get()
				...
				enr_results_3 = result3.get()
				print("enr")
				result4 = read_enrichment.delay("/code/clustering/data/test/enrichr_go/GO_Molecular_Function_2018.test_name.enrichr.reports.txt",pval_enr)
				result5 = read_enrichment.delay("/code/clustering/data/test2/enrichr_go/GO_Molecular_Function_2018.test_name.enrichr.reports.txt",pval_enr)
				result6 = read_enrichment.delay("/code/clustering/data/test3/enrichr_go/GO_Molecular_Function_2018.test_name.enrichr.reports.txt",pval_enr)
				result7 = read_enrichment_2.delay("/code/clustering/data/test2/enrichr_go/GO_Molecular_Function_2018.test_name.enrichr.reports.txt","/code/clustering/data/test3/enrichr_go/GO_Molecular_Function_2018.test_name.enrichr.reports.txt",pval_enr)
				enrichment_dict = result4.get()
				enrichment_dict_2 = result5.get()
				enrichment_dict_3 = result6.get()
				(enrichment_dict_4,enrichment_dict_5) = result7.get()
				...
				result2 = run_enrichment.delay("genelist_2.txt",pval_enr,"/code/clustering/data/test2/enrichr_reactome",['Reactome_2013','Reactome_2016'])
				...
				result5 = read_enrichment.delay("/code/clustering/data/test2/enrichr_reactome/Reactome_2016.test_name.enrichr.reports.txt",pval_enr)
		...
		if not (request.user.is_authenticated):
			...
			(ret_metadata1,ret_metadata2,ret_metadata3) = metd.get() 
			metadata_dict = [ret_metadata1,ret_metadata2,ret_metadata3]
		return render(request,'clustering/clustering_no_sessions.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'ret_metadata':ret_metadata,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict})
	...
	if('input_own_file' in request.POST and 'display_old_results' in request.POST and request.user.is_authenticated):
		...
		try:
			...
			if(enr_type == "kegg_enrichment"):
				...
				result1 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_" + session_id + ".txt",pval_enr,"clustering/data/test/enrichr_kegg",['KEGG_2016','KEGG_2013'])
				result2 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_1_" + session_id + ".txt",pval_enr,"clustering/data/test2/enrichr_kegg",['KEGG_2016','KEGG_2013'])
				result3 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_2_" + session_id + ".txt",pval_enr,"clustering/data/test3/enrichr_kegg",['KEGG_2016','KEGG_2013'])
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				...
				result1 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_" + session_id + ".txt",pval_enr,"clustering/data/test/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result2 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_1_" + session_id + ".txt",pval_enr,"clustering/data/test2/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result3 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_2_" + session_id + ".txt",pval_enr,"clustering/data/test3/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				...
				result1 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_" + session_id + ".txt",pval_enr,"/code/clustering/data/test/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result2 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_1_" + session_id + ".txt",pval_enr,"/code/clustering/data/test2/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result3 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_2_" + session_id + ".txt",pval_enr,"/code/clustering/data/test3/enrichr_go",['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				...
				result2 = run_enrichment.delay("/code/clustering/static/userfiles/genelist_2_" + session_id + ".txt",pval_enr,"/code/clustering/data/test2/enrichr_reactome",['Reactome_2013','Reactome_2016'])
				enr_results_2 = result2.get()
				print("enr")
				result5 = read_enrichment.delay("/code/clustering/data/test2/enrichr_reactome/Reactome_2016.test_name.enrichr.reports.txt",pval_enr)
				enrichment_dict = {}
			...
			return render(request,'clustering/clustering_step_2.html',{'list_of_files':list_of_files,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'path_heatmap':path_heatmap,'json_path':json_path,'output_plot_path':output_plot_path,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'enrichment_open':"true",'has_survival_plot':has_survival_plot,'conv_file':conv_file})
		except:
			return render(request,'clustering/errorpage.html',{'errors':"An error occurred during the algorithm run.",'hide_standard_message':"true"})
	else:
		ret_metadata = ""
		...
		if not (request.user.is_authenticated):
			...
			if not(session_id == ""):
				if(os.path.isfile("/code/clustering/static/userfiles/metadata_" + session_id + ".txt")):
					metd = list_metadata_from_file.apply_async(args=["/code/clustering/static/userfiles/metadata_" + session_id + ".txt"],countdown=0)
					(ret_metadata1,ret_metadata2,ret_metadata3) = metd.get() 
					metadata_dict = [ret_metadata1,ret_metadata2,ret_metadata3]
			cache.set('ret_metadata1', ret_metadata1)	
			cache.set('ret_metadata2', ret_metadata2)	
		...
		print("session id: " + str(session_id))
		return render(request,'clustering/clustering_step_1.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'ret_metadata':ret_metadata,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict,'progress_file':progress_file,'output_console_file':output_console_file,'loading_gif_1':loading_gif_1})
...
def clustering(request):
	...
	if('input_own_file' in request.POST and 'display_old_results' in request.POST and request.user.is_authenticated):
		if(request.POST['input_own_file'] and request.POST['display_old_results']):
			...
			loading_gif_1 = "userfiles/loading_1_" + session_id + ".gif"
			network_path = "userfiles/ntw_" + session_id + ".png"					           									     	
			return render(request, 'clustering/clustering.html', {'form':"",'images':"",'plot_div':"",'script':"",'path_heatmap':path_heatmap_2,'output_plot_path':output_plot_path_2,'json_path':json_path, 'list_of_files':list_of_files,'ret_dat':"",'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'list_of_files_2':list_of_files_2,'has_survival_plot':has_survival_plot,'output_console_file':output_console_file,'progress_file':progress_file,'loading_gif_1':loading_gif_1,'network_path':network_path})
	...
	if('redo_analysis' in request.POST and request.user.is_authenticated):
		...
		try:
			...
			if(enr_type == "kegg_enrichment"):
				...
				result1 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test/enrichr_kegg/" + session_id),['KEGG_2016','KEGG_2013'])
				result2 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_1_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test2/enrichr_kegg/" + session_id),['KEGG_2016','KEGG_2013'])
				result3 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_2_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test3/enrichr_kegg/" + session_id),['KEGG_2016','KEGG_2013'])
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				result4 = read_enrichment.delay(("/code/clustering/data/test/enrichr_kegg/" + session_id + "/KEGG_2013.test_name.enrichr.reports.txt"),pval_enr)
				result5 = read_enrichment.delay(("/code/clustering/data/test2/enrichr_kegg/" + session_id + "/KEGG_2013.test_name.enrichr.reports.txt"),pval_enr)
				result6 = read_enrichment.delay(("/code/clustering/data/test3/enrichr_kegg/" + session_id + "/KEGG_2013.test_name.enrichr.reports.txt"),pval_enr)
				result7 = read_enrichment_2.delay(("/code/clustering/data/test2/enrichr_kegg/" + session_id + "/KEGG_2013.test_name.enrichr.reports.txt"),("/code/clustering/data/test3/enrichr_kegg/" + session_id + "/KEGG_2013.test_name.enrichr.reports.txt"),pval_enr)
				# both groups
				enrichment_dict = result4.get()
				# group 1, group 2
				enrichment_dict_2 = result5.get()
				...
				result1 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test/enrichr_go/" + session_id),['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result2 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_1_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test2/enrichr_go/" + session_id),['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				result3 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_2_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test3/enrichr_go/" + session_id),['GO_Biological_Process_2018','GO_Cellular_Component_2018','GO_Molecular_Function_2018'])
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				result4 = read_enrichment.delay(("/code/clustering/data/test/enrichr_go/" + session_id + "/GO_Biological_Process_2018.test_name.enrichr.reports.txt"),pval_enr)
				result5 = read_enrichment.delay(("/code/clustering/data/test2/enrichr_go/" + session_id + "/GO_Biological_Process_2018.test_name.enrichr.reports.txt"),pval_enr)
				result6 = read_enrichment.delay(("/code/clustering/data/test3/enrichr_go/" + session_id + "/GO_Biological_Process_2018.test_name.enrichr.reports.txt"),pval_enr)
				result7 = read_enrichment_2.delay(("/code/clustering/data/test2/enrichr_go/" + session_id + "/GO_Biological_Process_2018.test_name.enrichr.reports.txt"),("/code/clustering/data/test3/enrichr_go/" + session_id + "/GO_Biological_Process_2018.test_name.enrichr.reports.txt"),pval_enr)
				enrichment_dict = result4.get()
				enrichment_dict_2 = result5.get()
				enrichment_dict_3 = result6.get()	
				(enrichment_dict_4,enrichment_dict_5) = result7.get()
				...
				enr_results_3 = result3.get()
				print("enr")
				result4 = read_enrichment.delay(("/code/clustering/data/test/enrichr_go/" + session_id + "/GO_Molecular_Function_2018.test_name.enrichr.reports.txt"),pval_enr)
				result5 = read_enrichment.delay(("/code/clustering/data/test2/enrichr_go/" + session_id + "/GO_Molecular_Function_2018.test_name.enrichr.reports.txt"),pval_enr)
				result6 = read_enrichment.delay(("/code/clustering/data/test3/enrichr_go/" + session_id + "/GO_Molecular_Function_2018.test_name.enrichr.reports.txt"),pval_enr)
				result7 = read_enrichment_2.delay(("/code/clustering/data/test2/enrichr_go/" + session_id + "/GO_Molecular_Function_2018.test_name.enrichr.reports.txt"),("/code/clustering/data/test3/enrichr_go/" + session_id + "/GO_Molecular_Function_2018.test_name.enrichr.reports.txt"),pval_enr)
				enrichment_dict = result4.get()
				enrichment_dict_2 = result5.get()
				enrichment_dict_3 = result6.get()
				(enrichment_dict_4,enrichment_dict_5) = result7.get()
			elif(enr_type == "reactome_enrichment"):
				result1 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test/enrichr_reactome/" + session_id),['Reactome_2013','Reactome_2016'])
				result2 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_1_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test2/enrichr_reactome/" + session_id),['Reactome_2013','Reactome_2016'])
				result3 = run_enrichment.delay(("/code/clustering/static/userfiles/genelist_2_" + session_id + ".txt"),pval_enr,("/code/clustering/data/test3/enrichr_reactome/" + session_id),['Reactome_2013','Reactome_2016'])
				enr_results = result1.get()
				enr_results_2 = result2.get()
				enr_results_3 = result3.get()
				print("enr")
				result4 = read_enrichment.delay(("/code/clustering/data/test/enrichr_go/" + session_id + "/GO_Molecular_Function_2018.test_name.enrichr.reports.txt"),pval_enr)
				result5 = read_enrichment.delay(("/code/clustering/data/test2/enrichr_reactome/" + session_id + "/Reactome_2016.test_name.enrichr.reports.txt"),pval_enr)
				result6 = read_enrichment.delay(("/code/clustering/data/test3/enrichr_go/" + session_id + "/GO_Molecular_Function_2018.test_name.enrichr.reports.txt"),pval_enr)
				enrichment_dict = result4.get()
				enrichment_dict_2 = result5.get()
				enrichment_dict_3 = result6.get()
...
'json_path':(json_path + "?foo=bar"),'output_plot_path':output_plot_path,'network_path':network_path,'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'enrichment_open':"true",'has_survival_plot':has_survival_plot,'output_console_file':output_console_file,'progress_file':progress_file,'loading_gif_1':loading_gif_1,'conv_file':conv_file})
		...
		return render(request,'clustering/clustering.html',{'list_of_files':list_of_files,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'network_path':network_path,'path_heatmap':path_heatmap,'json_path':json_path,'output_plot_path':output_plot_path,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'enrichment_open':"true",'has_survival_plot':has_survival_plot,'output_console_file':output_console_file,'progress_file':progress_file,'loading_gif_1':loading_gif_1,'network_file':network_file,'conv_file':conv_file})
	else:		
		...
		return render(request,'clustering/clustering.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'ret_metadata':ret_metadata,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'metadata_dict':metadata_dict,'enrichment_dict':"",'has_survival_plot':has_survival_plot,'output_console_file':output_console_file,'progress_file':progress_file,'loading_gif_1':loading_gif_1,'network_path':network_path,'conv_file':conv_file})
	...
	if('enrichment_type' in request.POST):
		...
		try:
			...
			if not(session_id_from_cache == 'has expired'):
				...
				cache.set("enrichment_dict_4",enrichment_dict_4)
				cache.set("enrichment_dict_5",enrichment_dict_5)
			return render(request,'polls/clustering_step_2.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'path_heatmap':("userfiles/"+path_heatmap),'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,
'json_path':("userfiles/"+json_path + "?foo=bar"),'output_plot_path':("userfiles/"+output_plot_path),'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'enrichment_open':"true",'has_survival_plot':"true",'conv_file':conv_file})
		except:
			return render(request,'clustering/errorpage.html',{'errors':"An error occurred during the algorithm run.",'hide_standard_message':"true"})
		return render(request,'polls/clustering_step_2.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'has_survival_plot':"true"})
	else:		
		analysis_running = cache.get('analysis_running', 'none')
		# if no analysis is running, remove loading image and text. this is to make sure after an incomplete analysis no "leftover" text with the status of last run is displayed
		if (analysis_running == 'none'):
		...
		if not (session_id_from_cache == "has_expired"):
			...
			if(os.path.isfile("/code/clustering/static/userfiles/ntw_" + session_id_from_cache + ".png")):
				network_path = "/code/clustering/static/userfiles/ntw_" + session_id_from_cache + ".png"
			return render(request,'clustering/clustering_step_2.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'ret_metadata':ret_metadata,'path_heatmap':path_heatmap,'json_path':json_path,'output_plot_path':output_plot_path,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'p_val':p_val,'has_survival_plot':"true",'network_path':network_path,'conv_file':conv_file})
		session_id = request.session._get_or_create_session_key()
		...
		if(os.path.isfile("/code/clustering/static/userfiles/ntw_" + session_id_from_cache + ".png")):
			network_path = "/code/clustering/static/userfiles/ntw_" + session_id_from_cache + ".png"
		return render(request,'clustering/clustering_step_2.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'path_heatmap':path99,'output_plot_path':output_plot_path,'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict,'has_survival_plot':"true",'network_path':network_path,'has_survival_plot':has_survival_plot,'conv_file':conv_file})
