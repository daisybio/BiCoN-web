...
def login_2(request):
	if('username' in request.POST and 'password' in request.POST):
		...
		if user is not None:
			...
			return redirect('clustering/clustering_6.html')
		else:
	...
	if(('myfile' in request.FILES or 'predef_file' in request.POST) and ('protfile' in request.FILES or ('parse_ndex_file' in request.POST and 'ndex_name_2' in request.POST))):
		if((request.FILES['myfile'] or request.POST['predef_file']) and (request.FILES['protfile'] or (request.POST['parse_ndex_file'] and request.POST['ndex_name_2']))):
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				#print("iasdfasdfsf")
				#print(ret_metadata1)
				write_pval.apply_async([p_val,"/code/clustering/static/pvalue.txt"],countdown=0)	
				...
				return render(request, 'clustering/clustering_6.html', {'form':"",'images':"",'plot_div':plot_div,'script':script,'plot2':plot2, 'list_of_files':list_of_files,'ret_dat':ret_metadata,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'list_of_files_2':list_of_files_2,'pval':p_val})
...
def clustering_6_4_part_2(request):
	...
	if(('myfile' in request.FILES or 'predef_file' in request.POST) and ('protfile' in request.FILES or ('parse_ndex_file' in request.POST and 'ndex_name_2' in request.POST))):
		...
		if((request.FILES['myfile'] or request.POST['predef_file']) and (request.FILES['protfile'] or (request.POST['parse_ndex_file'] and request.POST['ndex_name_2']))):
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				convert_gene_list.delay(adjlist,"/code/clustering/static/genelist_temp.txt")
				# write p-value in file for display
				write_pval.apply_async([p_val,"/code/clustering/static/pvalue.txt"],countdown=0)	
				plot2 = "test.png"
				...
				(ret_metadata1,ret_metadata2,ret_metadata3) = metd.get()
				plot2 = "test.png"
				# set session variable 'done' to true so that user is redirected to results page
				if request.user.is_authenticated:
				...
				# copy files with results from shared volume to static directory on django container			
	...
	if('redo_analysis' in request.POST and request.user.is_authenticated):
		...
		enrichment_dict_5 = {}
		if(enr_type == "kegg_enrichment"):
			result1 = run_enrichment_2.delay("genelist.txt",pval_enr,"clustering/data/test/enrichr_kegg")
			result2 = run_enrichment_2.delay("genelist_1.txt",pval_enr,"clustering/data/test2/enrichr_kegg")
			result3 = run_enrichment_2.delay("genelist_2.txt",pval_enr,"clustering/data/test3/enrichr_kegg")
			enr_results = result1.get()
			enr_results_2 = result2.get()
			enr_results_3 = result3.get()
			print("enr")
			...
			result1 = run_go_enrichment_2.delay("genelist.txt",pval_enr,"clustering/data/test/enrichr_go")
			result2 = run_go_enrichment_2.delay("genelist_1.txt",pval_enr,"clustering/data/test2/enrichr_go")
			result3 = run_go_enrichment_2.delay("genelist_2.txt",pval_enr,"clustering/data/test3/enrichr_go")
			#result1 = run_go_enrichment.delay("genelist.txt",pval_enr)
			enr_results = result1.get()
			enr_results_2 = result2.get()
			enr_results_3 = result3.get()
		...
		if('done' in request.session):
			...
			if(request.session['done'] == "true"): 
				...
				output_plot_path = "output_plotly_" + session_id + ".html"
				return render(request,'clustering/clustering_6_part_3.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'ret_metadata':ret_metadata,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'path4':path99,'json_path':json_path,'output_plot_path':output_plot_path,'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict})		
...
def clustering_6_4(request):
	...
	if('input_own_file' in request.POST and 'display_old_results' in request.POST and request.user.is_authenticated):
		if(request.POST['input_own_file'] and request.POST['display_old_results']):
			...
			make_empty_figure.apply_async(countdown=10)
			empty_log_file.apply_async(countdown=10)
			return render(request, 'clustering/clustering_6_part_4.html', {'form':"",'images':"",'plot_div':"",'script':"",'plot2':"",'path4':path99,'output_plot_path':output_plot_path_2,'json_path':json_path, 'list_of_files':"",'ret_dat':"",'ret_metadata1':ret_metadata_1,'ret_metadata2':ret_metadata_2,'ret_metadata3':ret_metadata_3,'list_of_files_2':""})
	...
	if('redo_analysis' in request.POST and request.user.is_authenticated):
		...
		if not(session_id_from_cache == 'has expired'):
			...
			output_plot_path = "output_plotly_" + session_id + ".html"
			return render(request,'clustering/clustering_6_part_4.html',{'list_of_files':list_of_files,'list_of_files_2':list_of_files_2,'path4':path99,
'json_path':json_path,'output_plot_path':output_plot_path,'metadata_dict':metadata_dict,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'enrichment_open':"true"})
		...
		#return clustering_6(request)
		#return HttpResponseRedirect('polls/clustering_6.html')
		return render(request,'clustering/clustering_6_part_4.html',{'list_of_files':list_of_files,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'path4':path99,'json_path':json_path,'output_plot_path':output_plot_path,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'enrichment_open':"true"})
	else:		
		#remove_loading_image.delay()
		ret_metadata = ""
	...
	#### this method is called if the user uploads everything himself. very nice for testing!
		...
		if(request.FILES['myfile'] and request.FILES['protfile'] and request.FILES['patientdata']):
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				write_pval.apply_async([p_val,"clustering/static/pvalue.txt"],countdown=0)
				#get metadata from file
				metd = list_metadata_3.apply_async(countdown=0)
				(ret_metadata1,ret_metadata2,ret_metadata3) = metd.get()
				convert_gene_list.delay(adjlist,"clustering/static/genelist_temp.txt")
				print(ret_metadata1) 	
				write_pval.apply_async([p_val,"clustering/static/pvalue.txt"],countdown=0)					
		...
		if(request.FILES['myfile'] and request.POST['parse_ndex_file'] and request.FILES['patientdata']):
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				#	fh2 = open("test_scripts_3/HPRD.cx",encoding='utf-8')
					...
					fh2 = open("clustering/data/ulitsky.txt",encoding='utf-8')
					ppistr = fh2.read()
				elif(ndex_file_id == "6"):
					fh2 = open("clustering/data/I2D.txt",encoding='utf-8')
					ppistr = fh2.read()
				elif(ndex_file_id == "7"):
				...
				make_empty_figure.apply_async(countdown=10)
				empty_log_file.apply_async(countdown=10)
				return render(request, 'clustering/clustering_6.html', {'list_of_files':list_of_files,'ret_metadata':ret_metadata,'result_99':ret_metadata,'list_of_files_2':list_of_files_2,'json_path':"test15.json",'heatmap_path':"test.png",'survival_graph':plot_div})
		...
		if(request.FILES['myfile'] and request.POST['ndex_file'] and request.POST['ndex_name']):
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				if(ndex_file_id == "1"):
					fh2 = open("clustering/data/APID.txt",encoding='utf-8')
				elif(ndex_file_id == "2"):
					fh2 = open("clustering/data/STRING.txt",encoding='utf-8')
				elif(ndex_file_id == "3"):
					fh2 = open("clustering/data/biogrid.human.entrez.tsv",encoding='utf-8')
				elif(ndex_file_id == "4"):
					fh2 = open("clustering/data/HPRD.txt",encoding='utf-8')
				elif(ndex_file_id == "5"):
					fh2 = open("clustering/data/ulitsky.txt",encoding='utf-8')
				elif(ndex_file_id == "6"):
					fh2 = open("clustering/data/I2D.txt",encoding='utf-8')
				elif(ndex_file_id == "7"):
					fh2 = open("clustering/data/biogrid_cel.txt",encoding='utf-8')
				elif(ndex_file_id == "8"):
					fh2 = open("clustering/data/biogrid_ath.txt",encoding='utf-8')
				elif(ndex_file_id == "9"):
					fh2 = open("clustering/data/biogrid_mus.txt",encoding='utf-8')
				elif(ndex_file_id == "10"):
					fh2 = open("clustering/data/biogrid_dme.txt",encoding='utf-8')
				elif(ndex_file_id == "11"):
					fh2 = open("clustering/data/biogrid_eco.txt",encoding='utf-8')
				elif(ndex_file_id == "12"):
					fh2 = open("clustering/data/biogrid_sce.txt",encoding='utf-8')
				elif(ndex_file_id == "13"):
					fh2 = open("clustering/data/biogrid_dan.txt",encoding='utf-8')
				ppistr = fh2.read()
				exprstr = request.FILES['myfile'].read().decode('utf-8')
				savedata_param = "false"
				plot_div = ""
		...
		if(request.FILES['myfile'] and request.POST['parse_ndex_file']):
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				lgmax = int(request.POST['L_g_max'])
				add_loading_image.delay()
				with open("/code//static/output_console.txt", "w") as text_file:
   					text_file.write("Your request is being processed...")
   					text_file.close()
				make_empty_figure.delay()
				ndex_file_id = request.POST.get("ndex_name_2")
		...
		if(request.POST['own_file']):
			...
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				make_empty_figure.apply_async(countdown=10)
				empty_log_file.apply_async(countdown=10)
				return render(request, 'clustering/clustering_6.html', {'form':"",'images':"",'div':"",'script':"",'plot2':plot2, 'list_of_files':list_of_files,'list_of_files_2':list_of_files_2})       		
		...
		if(request.FILES['myfile'] and request.FILES['protfile']):
			if('L_g_min' in request.POST and 'L_g_max' in request.POST):
				...
				make_empty_figure.apply_async(countdown=10)
				empty_log_file.apply_async(countdown=10)
				return render(request, 'clustering/clustering_6.html', {'form':"",'images':"",'div':div,'script':script,'plot2':plot2, 'list_of_files':list_of_files,'list_of_files_2':list_of_files_2})
		...
		if('L_g_min' in request.POST and 'L_g_max' in request.POST):
			if(request.POST['predef_file'] and request.POST['protfile']):
				...
				#else:
				remove_loading_image.delay()
				with open("clustering/static/metadata_99.html", "w") as text_file_4:
				...
				return render(request, 'clustering/clustering_6.html', {'plot2':plot2, 'list_of_files':list_of_files,'ret_metadata':ret_metadata,'result_99':ret_metadata,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'list_of_files_2':list_of_files_2})
		...
		if('L_g_min' in request.POST and 'L_g_max' in request.POST):
			if(request.POST['predef_file']):
				...
				cancer_type = request.POST.get("cancer_type")
				print("Cancer Type:" + str(cancer_type))
				fh2 = open("clustering/data/biogrid.human.entrez.tsv")
				ppistr = fh2.read()
				lgmin = int(request.POST['L_g_min'])
				lgmax = int(request.POST['L_g_max'])
				is_lungc = "false"					
		...
		if('group_for_enr' in request.POST):
			group_for_enr = request.POST.get('group_for_enr')
			#print(pval_enr)
		result1 = run_enrichment_2.delay("genelist_1.txt",pval_enr,"clustering/data/test/enrichr_kegg")
		result2 = run_enrichment_2.delay("genelist_2.txt",pval_enr,"clustering/data/test2/enrichr_kegg")
		result3 = run_enrichment_2.delay("genelist.txt",pval_enr,"clustering/data/test3/enrichr_kegg")
		enr_results = result1.get()
		enr_results_2 = result2.get()
		enr_results_3 = result3.get()
		print("enr")
		result4 = read_kegg_enrichment.delay("clustering/data/test/enrichr_kegg/KEGG_2013.test_name.enrichr.reports.txt",pval_enr)
		...
		if('ppi_path' in request.POST and 'heatmap_path' in request.POST and 'plot_path' in request.POST):
			...
			json_path = request.POST.get('ppi_path')
			output_plot_path = request.POST.get('plot_path')
		return render(request,'clustering/clustering_6.html',{'list_of_files':list_of_files,'ret_metadata1':ret_metadata1,'ret_metadata2':ret_metadata2,'ret_metadata3':ret_metadata3,'path4':path99,'json_path':json_path,'output_plot_path':output_plot_path,'enrichment_dict':enrichment_dict,'enrichment_dict_2':enrichment_dict_2,'enrichment_dict_3':enrichment_dict_3,'enrichment_dict_4':enrichment_dict_4,'enrichment_dict_5':enrichment_dict_5,'enrichment_open':"true"})
